...
import {FaShoppingCart, FaRegCopyright, FaRegHeart, FaStar} from "react-icons/fa";
...
const RestaurantCard = ({
  ...
  return (
    <div className="card">
      ...
      <h4>{area}</h4>
      <span>
      <h4><FaStar color="orange"/>{avgRating}</h4>
...
const Body = () => {
  return (
    <div className="res-container">
      {restaurantList.filter((restaurant) => restaurant.data.veg === true).map((restaurant) => {
